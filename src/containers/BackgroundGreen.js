...
const RnD = (props) => {
  ...
  return (
    <GenericLayout className="">
      <CRow>
        <div class=" bgColor margin-top col d-flex justify-content-center ">
          <h2>
            <center className="bgColor">Investigación y desarrollo</center>
          </h2>
        </div>
      </CRow>
      <center className="changeSize  bgColor ">
        {" "}
        ...
        <div className="col-md-4  bgColor">
          <CCard>
            <CCardHeader>
              <h2>
                {" "}
                <center className="bgColor">Desarrollar el futuro </center>{" "}
              </h2>
            </CCardHeader>
            <CCardBody>
              <center
        ...
        <div className="col-md-4  bgColor">
          <CCard>
            <CCardHeader>
              <h2>
                {" "}
                <center className="bgColor">Estudios y pruebas </center>{" "}
              </h2>
            </CCardHeader>
            <CCardBody>
              <center className="changeSize  bgColor">
      ...
      <div className="row">
        ...
        <div className="col-md-4">
          <center>
            <CButton className="w-50  " block color="danger">
              Mettiti in contatto
            </CButton>
          </center>
        </div>
