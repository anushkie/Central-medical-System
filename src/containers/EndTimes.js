...
const RnD = (props) => {
  ...
  return (
    <GenericLayout className="fontTimes">
      <CRow>
        <div class="fontTimes margin-top col d-flex justify-content-center">
          <h2>
            <center>Research and Develop</center>
          </h2>
        </div>
      </CRow>
      <center className="changeSize fontTimes">
      ...
      <CRow>
        ...
        <div className="col-md-4 fontTimes">
          <CCard>
            <CCardHeader>
              <h2>
                {" "}
      ...
      <div className="row">
        ...
        <div className="col-md-4">
          <center>
            <CButton className="w-50 fontTimes" block color="primary">
              Get in touch
            </CButton>
          </center>
        </div>
