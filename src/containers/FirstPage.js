...
"
      ...
      {dept_num == "2" && (
        <div className="data">
          ...
          treatment and prevention of diseases of the eye and visual system. The
          eye, its surrounding structures and the visual system can be affected
          by a number of clinical conditions. Ophthalmology involves diagnosis
          and therapy of such conditions, along with microsurgery.
        </div>
      )}
      ...
      {dept_num == "3" && (
        <div className="data">
          ...
          The branch of surgery concerned with disorders of the spine and joints
          and the repair of deformities of these parts. Orthopaedic surgeons
          specialise in surgical treatments for problems caused by disease and
          injury (trauma) in the bones, joints and other structures involved in
          making the body move. Most orthopaedic surgeons specialise in
          particular procedures or areas of the body.
        </div>
      )}
      ...
      {dept_num == "4" && (
        <div className="data">
          ...
          ovaries and breasts. Anyone with female organs may see a gynecologist.
          80% of those who see one are between 15 to 45 years old. Gynecologists
          give reproductive and sexual health services that include pelvic
          exams, Pap tests, cancer screenings, and testing and treatment for
          vaginal infections. They diagnose and treat reproductive system
          disorders such as endometriosis, infertility, ovarian cysts, and
          pelvic pain. They may also care for people with ovarian, cervical, and
      ...
      {dept_num == "8" && (
        <div className="data">
          ...
          treats problems with the gut (gastro-intestinal tract), including the
          oesophagus (gullet), stomach, small bowel, colon (large bowel),
          pancreas, liver and gallbladder. Common reasons to be referred to the
          department. Trained gastroenterologists develop and run endoscopy
          services for diagnostic, therapeutic and screening endoscopy. All
          specialists are competent at upper gastrointestinal (GI) endoscopy.
          Most will be trained in lower GI endoscopy (flexible sigmoidoscopy and
          colonoscopy). Some will have had additional training in hepatobiliary
          endoscopy (ERCP) or small bowel endoscopy (wireless capsule endoscopy
          or enteroscopy). Most will participate in acute gastroenterology
          admissions and manage a broad range of gastrointestinal disease,
          either in outpatients or following admission.
        </div>
      )}
    </GenericLayout>
  );
