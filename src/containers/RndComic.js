...
const RnD = (props) => {
  ...
  return (
    <GenericLayout className="fontComic">
      <CRow>
        <div class=" fontComic margin-top col d-flex justify-content-center ">
          <h2>
            <center>Research and Develop</center>
          </h2>
        </div>
      </CRow>
      <center className="changeSize fontComic">
      ...
      <br /> <br />
      <CRow>
        <div className="col-md-4 fontComic">
          <CCard>
            <CCardHeader>
              <h2>
                {" "}
      ...
      <div className="row">
        ...
        <div className="col-md-4">
          <center>
            <CButton className="w-50 fontComic" block color="primary">
              Get in touch
            </CButton>
          </center>
        </div>
