...
const RnD = (props) => {
  ...
  return (
    <GenericLayout className="fontMono">
      <CRow>
        <div class="fontMono margin-top col d-flex justify-content-center ">
          <h2>
            <center>Research and Develop</center>
          </h2>
        </div>
      </CRow>
      <center className="changeSize fontMono ">
      ...
      <br /> <br />
      <CRow>
        <div className="col-md-4 fontMono">
          <CCard>
            <CCardHeader>
              <h2>
                {" "}
      ...
      <div className="row">
        ...
        <div className="col-md-4">
          <center>
            <CButton className="w-50 fontMono" block color="primary">
              Get in touch
            </CButton>
          </center>
        </div>
