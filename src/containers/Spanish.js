    ...
    <GenericLayout>
      <CRow>
        <div class=" margin-top col d-flex justify-content-center">
          <h2>
            <center>Investigación y desarrollo</center>
          </h2>
        </div>
      </CRow>
        ...
        <div className="col-md-4">
          <CCard>
            <CCardHeader>
              <h2>
                {" "}
                <center>Desarrollar el futuro </center>{" "}
              </h2>
            </CCardHeader>
            <CCardBody>
              <center className="changeSize">
        ...
        <div className="col-md-4">
          <CCard>
            <CCardHeader>
              <h2>
                {" "}
                <center>Estudios y pruebas</center>{" "}
              </h2>
            </CCardHeader>
            <CCardBody>
              <center className="changeSize">
        ...
        <div className="col-md-4">
          <CCard>
            <CCardHeader>
              <h2>
                {" "}
                <center>Nuestras áreas de investigación</center>{" "}
              </h2>
            </CCardHeader>
            <CCardBody>
              <center className="changeSize">
