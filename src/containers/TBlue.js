...
const RnD = () => {
  ...
  return (
    <GenericLayout>
      <CRow>
        <div class="color margin-top col d-flex justify-content-center">
          <h2>
            <center className="color">Investigación y desarrollo</center>
          </h2>
        </div>
      </CRow>
      <center className="changeSize color">
        ...
        <div className="col-md-4">
          <CCard>
            <CCardHeader>
              <h2>
                {" "}
                <center className="color">Desarrollar el futuro </center>{" "}
              </h2>
            </CCardHeader>
            <CCardBody>
              <center className="changeSize color">
        ...
        <div className="col-md-4">
          <CCard>
            <CCardHeader>
              <h2>
                {" "}
                <center className="color">Estudios y pruebas</center>{" "}
              </h2>
            </CCardHeader>
            <CCardBody>
              <center className="changeSize color">
      ...
      <div className="row">
        ...
        <div className="col-md-4">
          <center>
            <CButton className="w-50 color" block color="light">
              Mettiti in contatto
            </CButton>
          </center>
        </div>
