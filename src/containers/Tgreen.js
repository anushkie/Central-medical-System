    ...
    <GenericLayout>
      <CRow>
        <div class="color margin-top col d-flex justify-content-center">
          <h2>
            <center className="greenColor">Investigación y desarrollo</center>
          </h2>
        </div>
      </CRow>
      <center className="changeSize greenColor">
        ...
        <div className="col-md-4">
          <CCard>
            <CCardHeader>
              <h2>
                {" "}
                <center className="greenColor">Estudios y pruebas</center>{" "}
              </h2>
            </CCardHeader>
            <CCardBody>
              <center className="changeSize greenColor">
      ...
      <div className="row">
        ...
        <div className="col-md-4">
          <center>
            <CButton className="w-50 greenColor" block color="light">
              Mettiti in contatto
            </CButton>
          </center>
        </div>
