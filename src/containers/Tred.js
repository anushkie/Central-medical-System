...
const RnD = () => {
  ...
  return (
    <GenericLayout>
      <CRow>
        <div class="colorRed margin-top col d-flex justify-content-center">
          <h2>
            <center className="colorRed">Investigación y desarrollo</center>
          </h2>
        </div>
      </CRow>
      <center className="changeSize colorRed">
        ...
        <div className="col-md-4">
          <CCard>
            <CCardHeader>
              <h2>
                {" "}
                <center className="colorRed">Estudios y pruebas</center>{" "}
              </h2>
            </CCardHeader>
            <CCardBody>
              <center className="changeSize colorRed">
      ...
      <div className="row">
        ...
        <div className="col-md-4">
          <center>
            <CButton className="w-50 colorRed" block color="primary">
              Mettiti in contatto
            </CButton>
          </center>
        </div>
