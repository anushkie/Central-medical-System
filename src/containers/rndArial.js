...
import AccessibleLAyout from "../containers/AccessibleLAyout";
...
const RnD = (props) => {
  ...
  return (
    <AccessibleLAyout className="fontArial">
      <CRow>
        <div class="fontArial margin-top col d-flex justify-content-center">
          <h2>
            <center>Research And Develop</center>
          </h2>
        </div>
      </CRow>
      <center className=" fontArial">
      ...
      <CRow>
        <div className="col-md-4">
          <CCard>
            ...
            <CCardBody>
              <center className="changeSize fontArial">
